    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form action="editproceso2.php" method="POST" class="form-padding">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" placeholder="Nombre"
                                    maxlength="50" data-toggle="tooltip" data-placement="top"
                                    title="Escribe un nuevo nombre" name="Nombre"
                            ...
                            <div class="group-material">
                                <input type="email" class="material-control tooltips-general"
                                    placeholder="Correo electronico" maxlength="50" data-toggle="tooltip"
                                    data-placement="top" title="Escribe un nuevo correo" name="Correo"
                            ...
                            <div class="group-material">
                                <input type="password" class="material-control tooltips-general"
                                    ...
                                    data-placement="top" title="Escribe contraseña nueva" name="Pass"
                                    value="<?php echo $persona->Pass;?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
