        ...
        <div class="full-reset container-menu-movile nav-lateral-scroll">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    <li><a href="index.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Iniciar sesión</a></li>
                    <li><a href="TuCuenta.php"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Crear cuenta</a></li>
                    <li><a href="../catalog.html"><i class="zmdi zmdi-home zmdi-hc-fw"></i>&nbsp;&nbsp; Entrar sin cuenta</a></li>   
                </ul>
            </div>
        </div>
    </div>
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="index.php">Iniciar sesión con tu cuenta</a> </div>
                <div class="tile-num full-reset"></div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
                <div class="tile-name all-tittles"><a href="TuCuenta.php">Crear tu cuenta</a></div>
                <div class="tile-num full-reset"></div>
            </article>
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles"><a href="../catalog.html"> Entrar al sitio sin cuenta</a></div>
                <div class="tile-num full-reset"></div>
            </article>
            
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-book"></i></div>
                <div class="tile-name all-tittles"><a href="admin.php"> Entrar al sitio como Administrador</a></div>
                <div class="tile-num full-reset"></div>
            </article>
            <br>
            <article class="tile">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <p>
                            Regulación y distribución de material literario bajo derechos de autor.
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
